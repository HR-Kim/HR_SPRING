...
public class UserDaoJdbc implements UserDao {
	...
	public List<User> getAll() {
		String query = "SELECT u_id, name, passwd, h_level, login, recommend, email, TO_CHAR(reg_dt, 'YYYY/MM/DD') reg_dt FROM users ORDER BY u_id";
	...
	public int update(User user) {
		...
		String query = sb.toString();
		Object[] args = {user.getName(), user.getPasswd(), user.gethLevel().intValue(), user.getLogin(), user.getRecommend(), user.getEmail(), user.getU_id()};
